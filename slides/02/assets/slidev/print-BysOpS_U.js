import{d as _,P as u,z as h,f as n,g as t,t as s,C as c,F as f,Q as g,o as l,i as v,e as x,B as b}from"../modules/vue-DNyJ_Q7a.js";import{l as k,k as y,h as m}from"../index-BnJQmpvM.js";import{_ as N}from"./NoteDisplay.vue_vue_type_style_index_0_lang-C13VJQcx.js";import"../modules/shiki-DzZAIVy9.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(D){const{slides:d,total:p}=k();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
